...
const technologies: TechnologyProps[] = [
  { name: 'React', icon: '/tech-icons/react-original.svg' },
  { name: 'Next.js', icon: '/tech-icons/nextjs.svg' },
  { name: 'TypeScript', icon: '/tech-icons/typescript.svg' },
  { name: 'JavaScript', icon: '/tech-icons/javascript-original.svg' },
  { name: 'Tailwind', icon: '/tech-icons/tailwindcss-plain.svg' },
  { name: 'Node.js', icon: '/tech-icons/nodejs-original.svg' },
  { name: 'Java', icon: '/tech-icons/java-original.svg' },
  { name: 'AWS', icon: '/tech-icons/aws-original.svg' },
  { name: 'Vercel', icon: '/tech-icons/vercel-original.svg' },
  { name: 'Firebase', icon: '/tech-icons/firebase.svg' },
  { name: 'HTML5', icon: '/tech-icons/html5-original.svg' },
  { name: 'CSS3', icon: '/tech-icons/css3-original.svg' },
  { name: 'Figma', icon: '/tech-icons/figma-original.svg' },
  { name: 'Git', icon: '/tech-icons/git.svg' },
  { name: 'ESLint', icon: '/tech-icons/eslint-original.svg' },
